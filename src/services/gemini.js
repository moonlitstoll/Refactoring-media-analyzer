...
2. **전수 및 순차 분석 (누락 금지)**: 문장의 첫 단어부터 마지막 기능어(cho, đã, đang, mới, nhé 등)까지 단 하나도 빠짐없이 순서대로 분석하십시오. 단, 6번의 '문법 패턴'에 해당하는 단어들은 해당 패턴 행에서 한꺼번에 분석하되, 문장 전체 흐름에서 누락되는 단어가 없어야 합니다.
