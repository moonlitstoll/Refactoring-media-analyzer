...
**[구현 예시]**
문장: Mình phải đưa ra đánh giá năm sao.
[번역] 나는 별점 5점을 주어야 한다.
[분석] Mình phải: 나는 ~해야 한다 (mình: 나 + phải: ~해야 한다/의무)
[분석] đưa ra: 내놓다/제시하다 (đưa: 내다/주다 + ra: 밖으로)
[분석] đánh giá năm sao: 별점 5점 평가/리뷰 (đánh giá: 평가/리뷰 + năm sao: 별 다섯 개/5점)
...
문장번호: [번호] 끝
