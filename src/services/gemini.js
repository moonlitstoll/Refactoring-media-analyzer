...
3. 의미 단위 세밀 청킹 및 문장 분리 (절대 원칙): 한 줄(하나의 타임스탬프)에 절대로 2개 이상의 완전한 문장을 넣지 마십시오. 마침표(.), 물음표(?), 느낌표(!) 등 문장 종결 부호가 나오면 반드시 그 지점에서 줄을 끊고 새로운 타임스탬프를 발급하십시오. 하나의 타임스탬프당 최대 15단어를 초과하지 마십시오. 논리적으로 자연스러운 곳에서 끊어 5~15단어 이내로 쪼개십시오.
