...
4. **단어별 단일 행(One Line) 분석**: 모든 단어(복합어 포함) 설명은 반드시 **한 줄**에 끝내십시오. 다음절 단어나 복합어 설명 시, 음절별 의미는 별도의 행을 만들지 말고 해당 행 안에서 '+' 또는 '()'를 사용하여 한꺼번에 설명하십시오.
...
7. **미니멀리즘 유지**: 문법 용어('대명사' 등)와 뻔한 정보는 삭제하고, 핵심 의미 위주로 가장 짧고 명확한 단어로 설명하십시오.
